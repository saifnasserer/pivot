...
class StylingStep extends StatelessWidget {
  ...
  List<String> _getAvailableTagsForLevels(List<String> selectedLevels) {
    // Always include "اخبار عامة" tag
    final availableTags = ['اخبار عامة'];
    ...
    // If ALL levels are selected, only show "اخبار عامة" tag
    final allLevels = [
      'الفرقة الأولى',
      'الفرقة الثانية',
      'الفرقة الثالثة',
    ...
    if (selectedLevels.length == allLevels.length &&
      ...
      return availableTags; // Only "اخبار عامة"
    }
    ...
    if (hasLevel1Or2 && !hasLevel3Or4) {
      ...
      // Mixed levels: Only "اخبار عامة" is available
