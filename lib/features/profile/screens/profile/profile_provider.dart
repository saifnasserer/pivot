...
class ProfileProvider with ChangeNotifier {
  ...
  Future<void> fetchProfileData(UserProfile userProfile) async {
    try {
      ...
      // Defer provider updates to avoid build-time notifications
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (!areProvidersValid()) return;
      ...
      // Defer the rest of the operations to avoid build-time notifications
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        try {
          ...
          // Handle any errors in the deferred operation
        }
      });
    } catch (e) {}
  }
